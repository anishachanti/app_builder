def planner_prompt(user_prompt: str) -> str:
    PLANNER_PROMPT = f"""
You are the PLANNER agent. Convert the user prompt into a COMPLETE engineering prompt plan
...
RULES:
    ...
    -In each task description:
      ...
      * Mention how this task depends on or will be used ny previous tasks.
